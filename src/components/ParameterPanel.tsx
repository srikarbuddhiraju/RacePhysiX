  ...
  return (
    <div className="param-panel">
      ...
      {tab === 'suspension' && <>
        ...
        <div className="param-section-label">Roll Centre Heights (Stage 41)</div>
        <SliderRow cfg={{ label: 'Front RC height', key: 'frontRollCentreHeightMm', min: 0, max: 100, step: 5, unit: 'mm', format: v => `${v}`, tip: 'Front roll centre height above ground. RC above ground → some lateral load transfer bypasses the springs (geometric path). Higher RC = less body roll but more jacking force. Typical DWB front: 20–50 mm. RCVD §17.5.' }} params={params} set={set} />
        <SliderRow cfg={{ label: 'Rear RC height',  key: 'rearRollCentreHeightMm',  min: 0, max: 120, step: 5, unit: 'mm', format: v => `${v}`, tip: 'Rear roll centre height. Raising the rear RC increases geometric load transfer at rear → increases rear stiffness → understeer tendency. Typical DWB rear: 30–60 mm.' }} params={params} set={set} />
